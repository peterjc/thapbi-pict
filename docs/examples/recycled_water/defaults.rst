...
.. code:: console
    ...
    ...
    onebp classifier assigned species/genus to 448 of 794 unique sequences from 1 files
...
Notice the output reported a taxonomic assignment for 448 of 794 unique
sequences - that's only 56%, but considerably higher if we consider the reads.
