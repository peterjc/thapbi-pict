...
.. code:: console
    ...
    Assessed onebp vs known in 1 files (211 species)
    #Species                     TP  FP  FN  TN
    OVERALL                      8   1   7   195
    ...
    OTHER 195 SPECIES IN DB      0   0   0   195
...
OTHER 195 SPECIES IN DB     0  0  0  195 0.00 0.000
=========================== == == == === ==== ===========

The ``OVERALL`` line tells us that there were 8 true positives, 1 false
positives, 7 false negatives, and 195 true negatives. The final number needs a
little explanation. First, 8+1+7+195 = 211, which is the number of species in
the database. With only one sample being considered, 195 is the number of other
...
.. code:: console
    ...
    Assessed onebp vs known in 4 files (211 species)
...
Their total, 32+7+13+792 = 844 = 4 * 211, is the number of samples times the
